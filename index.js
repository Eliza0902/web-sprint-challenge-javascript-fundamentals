...
// The function is inside of the function block so it can access anything in the outer function.
//This is a closure.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    let displayNames = [];
      array.forEach(function(item){displayNames.push( `name: ${item.animal_name}, scientific: ${item.scientific_name}`)});
  return displayNames
  ...
  */
  ...
  function lowerCaseNames(array){
    let animalNames = array.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const popControl = array.filter(function(items){
